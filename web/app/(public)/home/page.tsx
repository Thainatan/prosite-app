  ...
  return (
    <div style={{fontFamily:'sans-serif',margin:0,padding:0,background:'#fff'}}>
      ...
      <section id="pricing" style={{background:'#F7F8FC',padding:'80px 40px',borderTop:'1px solid #EAECF2'}}>
        <div style={{textAlign:'center',marginBottom:48}}>
          <h2 style={{fontSize:36,fontWeight:800,color:'#1C2B3A',marginBottom:12}}>Simple, transparent pricing</h2>
        ...
        <div style={{display:'flex',gap:20,justifyContent:'center',flexWrap:'wrap',maxWidth:900,margin:'0 auto'}}>
          {[
            ...
            {name:'Company',price:'$79',desc:'For growing teams up to 5',bg:'#1C2B3A',featured:true,features:['Up to 5 users','Everything in Solo','Team roles & permissions','Change orders','Priority support','Custom branding']},
